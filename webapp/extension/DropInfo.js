...
sap.ui.define(["jquery.sap.global", "sap/ui/core/dnd/DragDropBase"],
	...
	DropInfo.prototype.isDroppable = function(oControl, oEvent) {
		...
		var oMetadata = {draggable: true, droppable: true}; //oDropTarget.getMetadata().getDragDropInfo(sTargetAggregation);
